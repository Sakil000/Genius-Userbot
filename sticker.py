...
#         return await kang_msg.edit("`Please Reply to a Sticker!`")
    ...
    if exist:
        ...
        await kang_msg.edit("**Sticker Kanged!** \n\n**Emoji:** {} \n**Pack:** [Here](https://t.me/addstickers/{})".format(emoji, packshortname))
        try:
            if os.path.exists("Kanged_Sticker_Its_Me_SakiL.png"):
                os.remove("Kanged_Sticker_Its_Me_SakiL.png")
...
def resize_image(image):
    ...
    file_name = "Kanged_Sticker_Its_Me_SakiL.png"
...
**ᴜsᴀɢᴇ:**
`.kang` - **Rᴇᴘʟʏ Tᴏ Sᴛʀɪᴄᴋᴇʀ Tᴏ Kᴀɴɢ Sᴀᴋɪʟ.**
